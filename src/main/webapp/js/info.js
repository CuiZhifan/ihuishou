    ...
    success:function (data) {
        ...
        for(var i=0;i<page1l;i++){
            ...
            for (var j=0;j<infol;j++){
                page1html += "" +
                    "<li autocomplete=\"off\" class=\"\" onClick=\"property_click(this,"+i+","+info[j].discountValue+")\" name=\"sx_child_"+i+"\" v-for=\"info in estimate.infolist\">\n" +
        ...
        for(var i=0;i<page2l;i++){
            ...
            for (var j=0;j<infol;j++){
                page2html +=
                    "<input type=\"hidden\" name=\"desc_id[]\" id=\"desc_id_"+j+"\" value=\""+info[j].discountValue+"\"/>" +
                    "<li onClick=\"item_click(this,"+j+","+info[j].discountValue+")\" name=\"mx_child_"+j+"\">\n" +
        ...
        for(var i=0;i<page3l-1;i++){
            ...
            for (var j=0;j<infol;j++){
                page3html += "" +
                    "<li autocomplete=\"off\" class=\"\" onClick=\"property_click(this,'a"+i+"',"+info[j].discountValue+")\" name=\"sx_child_"+i+"\" v-for=\"info in estimate.infolist\">\n" +
                    "   <div class=\"pro_div\"><span class=\"property_value\"><i>"+info[j].infoName+"</i><ins>"+info[j].infoText+"</ins></span><span\n" +
                    "       class=\"gou\"></span></div>\n" +
                    "</li>\n"
            }
        ...
        for (var j=0;j<infol;j++){
            page3html +=
                "<input type=\"hidden\" name=\"desc_id[]\" id=\"desc_id_b"+j+"\" value=\"info[j].discountValue\"/>" +
                "<li onClick=\"item_click(this,'b"+j+"',"+info[j].discountValue+")\" name=\"mx_child_"+"b"+j+"\">\n" +
                "   <div class=\"pro_div\"><span class=\"property_value\"><i>"+info[j].infoName+"</i><ins>"+info[j].infoText+"</ins></span>\n" +
                "   <span class=\"gou\"></span></div>\n" +
                "</li>";
        }
